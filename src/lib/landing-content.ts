const arabicCopy = (marketName: "الإمارات" | "الأردن", marketLabel: "Arabic - UAE" | "Arabic - Jordan") => ({
  ...
  title: `ChatZi مستقبل محادثات العملاء في ${marketName}`,
  subtitle:
    "مساعد استقبال وعمليات يعمل على مدار الساعة: يرد على العملاء، يفهم الطلب، يجمع البيانات المهمة، ينفذ خطوات العمل، ثم يحول المحادثة للفريق عندما تحتاج تدخل بشري.",
  primary: "إنشاء حساب",
